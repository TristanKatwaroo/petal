...
//   return (
//     <div className="w-[80vw] max-w-full bg-white rounded-xl shadow-lg p-6 overflow-hidden">
//       <div className="flex items-center justify-between mb-4">
//         <div className="flex items-center space-x-2">
//           <Bus className="h-6 w-6 text-blue-600" />
//           <h2 className="text-2xl font-bold text-gray-900">Nearby Transit</h2>
//         </div>
...
//   if (error) {
//     return (
//       <div className="flex items-center justify-center h-48 bg-red-50 dark:bg-red-900 rounded-lg">
//         <div className="flex flex-col items-center space-y-2">
...
//   return (
//     <div className="w-[80vw] max-w-full bg-white dark:bg-gray-900 rounded-xl shadow-lg p-6 overflow-hidden">
//       <div className="flex items-center justify-between mb-4">
//         <div className="flex items-center space-x-2">
...
//                 : "hover:bg-gray-100 dark:hover:bg-gray-800 active:bg-gray-200 dark:active:bg-gray-600"
//             }`}
//           >
...
//                 } dark:opacity-90`}
//               >
//                 <div className="p-4 text-white dark:text-gray-200">
//                   <div className="flex items-center justify-between mb-3">
//                     <span className="text-4xl font-bold">
//                       {stop.route_short_name}
//                     </span>
...
function NearbyStops() {
  ...
  if (loading) {
    return (
      <div
        ...
        style={{ backgroundColor: "hsl(20, 14.3%, 4.1%)" }}
      >
        <div className="flex flex-col items-center space-y-2">
          <Loader2 className="h-8 w-8 animate-spin text-blue-500" />
          <p className="text-gray-600 dark:text-gray-300">
  ...
  return (
    <div
      className="w-[80vw] max-w-full rounded-xl shadow-lg p-6 overflow-hidden bg-white dark:bg-transparent"
      style={{ backgroundColor: "hsl(20, 14.3%, 4.1%)" }}
    >
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center space-x-2">
        ...
        >
          {stops.map((stop, index) => (
            ...
            >
              ...
              >
                <div className="p-4 text-white dark:text-gray-100">
                  <div className="flex items-center justify-between mb-3">
                    <span className="text-4xl font-bold">
                      {stop.route_short_name}
                    </span>
